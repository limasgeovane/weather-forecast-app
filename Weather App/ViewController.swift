...
//  Weather App
//
//  Created by Geovane Lima dos Santos on 24/10/24.
//
...
class ViewController: UIViewController {
    ...
    private lazy var hourlyCollectionView: UICollectionView = {
        ...
        collectionView.register(HourlyForescastCollectionViewCell.self, forCellWithReuseIdentifier: HourlyForescastCollectionViewCell.indentifier)
    ...
    private var city = City(lat: "-15.7801", lon: "-47.9292", name: "Brasília")
...
extension ViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HourlyForescastCollectionViewCell.indentifier, for: indexPath) as? HourlyForescastCollectionViewCell else {
